...
namespace pmcenter
{
    public static partial class Methods
    {
        ...
        {
            Version newVersionInDotnet3 = Environment.Version;
            if (newVersionInDotnet3.Major == 3)
            {
                return newVersionInDotnet3;
            }

            try
            {
                string searchPattern = "Microsoft.NETCore.App ";
                ...
                while (true)
                {
                    ...
                    string versionString = output.Substring(indexOfStartingSpace + 1,
                        indexOfEndingSpace - indexOfStartingSpace - 1);
            ...
            {
                Log(
                    $"pmcenter is unable to detect your .NET Core installation: {ex.Message}, you need to have .NET Core 3.1 (runtime) installed in order to run pmcenter v2 or up.",
                    LogLevel.Warning);
