...
namespace pmcenter
{
    public static partial class EventHandlers
    {
        public static async void CtrlCHandler(object sender, ConsoleCancelEventArgs e)
        {
            ...
            {
                Log(
                    "Keyboard interrupt is currently being ignored. To change this behavior, set \"IgnoreKeyboardInterrupt\" key to \"false\" in pmcenter configurations.",
                    LogLevel.Warning);
                return;
            }
